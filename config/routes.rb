Rails3Importer::Application.routes.draw do
  ...
  match '/new_groups/create_groups_below' => 'groups#create_groups_below'
  ...
  match '/new_groups/get_groups_hierarchy' => 'groups#get_groups_hierarchy'
  ...
  match '/new_groups/clone_webforms' => 'groups#clone_webforms'
